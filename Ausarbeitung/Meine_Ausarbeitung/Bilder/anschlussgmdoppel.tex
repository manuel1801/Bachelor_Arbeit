...
%
\draw ([xshift=1cm,yshift = -1cm]motor.south) -- ([xshift=4cm,yshift = -1cm]motor.south) --
			([xshift=4cm,yshift = 0cm]motor.center);
\draw decorate[decoration={name = coil,pre length = 2pt,post length = 2pt,segment length=2.5mm,amplitude=2mm}] 
			{([xshift= 4cm,yshift = 0cm]motor.center) --([xshift=3cm,yshift = 0cm]motor.center)};
\draw ([xshift=3cm,yshift = 0cm]motor.center) -- ([xshift=3cm,yshift = 1.5cm]motor.north);
%
...
%
\filldraw[fill = white] ([xshift= 4cm,yshift = 0cm]motor.center) circle (2pt) node[right] {D1};
\filldraw[fill = white] ([xshift=3cm,yshift = 1cm]motor.center) circle (2pt) node[right] {D2};
%
%
