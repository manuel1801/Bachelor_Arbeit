...
%Erregerwicklung#
%
\draw ([xshift=1.25cm,yshift = -1cm]motor.south) --
			([xshift=1.25cm,yshift = 0cm]motor.center);
\draw decorate[decoration={name = coil,pre length = 2pt,post length = 2pt,segment length=2.5mm,amplitude=2mm}] 
			{([xshift= 1.25cm,yshift = 0cm]motor.center) --([xshift=2.25cm,yshift = 0cm]motor.center)};			
\draw	([xshift=2.25cm,yshift = 0cm]motor.center) -- ([xshift=2.25cm,yshift = 1cm]motor.north) --
			([xshift=0cm,yshift = 1cm]motor.north);

\filldraw	([xshift=1.25cm,yshift = -1cm]motor.south) circle (1pt);
\filldraw	([xshift=0cm,yshift = 1cm]motor.north) circle (1pt);

%
%UA
\draw [-latex,shorten <= 4pt,shorten >=4pt] ([xshift = 0cm,yshift = 1.5cm]motor.north) -- 
([xshift = 1.5cm,yshift = 1.5cm]motor.north) node [above] {$U$} -- ([xshift = 3cm,yshift = 1.5cm]motor.north);
%
%IA
\draw [-latex,shorten <= 4pt,shorten >=4pt] ([xshift = 0cm,yshift = 1.5cm]motor.north) -- 
([xshift = 0cm,yshift = 0.55cm]motor.north) node [above left] {$I_{\text{A}}$};
...
%
\filldraw[fill = white] ([xshift= 2.25cm,yshift = 0.5cm]motor.north) circle (2pt) node[right] {E1};
\filldraw[fill = white] ([xshift= 1.25cm,yshift = 0cm]motor.center) circle (2pt) node[above left] {E2};
%
