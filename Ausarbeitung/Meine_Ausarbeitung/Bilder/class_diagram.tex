...
\begin{tikzpicture}   
            ...
            \umlclass[x=-0.5, y=0.2]{Motion}{ 
              statick\text{\_}background : numpy.array
              }{ 
            ...
            \umlclass[y=-4.2]{InferenceModel}{ 
                ...
                string : device\text{\_}name
                }{ 
                + init(device\text{\_}name)\\  
            ...
            \umlclass[y=-1, x=5.6]{ExecInferModel}{ 
                ...
                + init(exec\text{\_}net, labels, in,output\text{\_}blob)\\
