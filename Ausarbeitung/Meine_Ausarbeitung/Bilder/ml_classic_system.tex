...
\begin{tikzpicture}
    ...
    \node [textfeld, left=of system.167] (inputs) {Inputs};
    \node [textfeld, left=of system.193] (regeln) {Regeln};
    \node [textfeld, right=of system] (output) {Output};

    \node [textfeld, left=of system2.167] (inputs2) {Inputs};
    \node [textfeld, left=of system2.193] (output2) {Output};
