...
Frameworks eine vereinfachete Möglichkeit die Modelle zu konstruieren.

Einige der bekannten Open Source sind Tensorflow, Caffe, Torch, oder 
Scikit-Learn.


TensorFlow, welches in der Thesis verwendet wurde, stammt von 
Google.
Es ist flexibel kann sowohl auf CPU als auc GPU ausgeführt werden, 
und wird viel in der Forschung eingesetzt.
