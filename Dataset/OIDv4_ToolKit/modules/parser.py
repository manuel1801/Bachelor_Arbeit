...
def parser_arguments():
    ...
    parser = argparse.ArgumentParser(
        description='Open Image Dataset Downloader')
    ...
    parser.add_argument('--image_IsDepiction', required=False, choices=['0', '1'], default='0',
                        metavar="1 or 0",
                        help='Optional characteristic of the images. Indicates that the object is a depiction.')
    parser.add_argument('--image_IsInside', required=False, choices=['0', '1'], default='0',
                        metavar="1 or 0",
