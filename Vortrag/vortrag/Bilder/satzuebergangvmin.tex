...
\visible<2->{\draw[thick,dashed,rounded corners=12pt](start)--(ecke)--(ende);}
%
...
%
\draw[thick,blue](0,0.6)--(1.25,0.6)--(1.5,0.2)--(1.5,0);
\draw[thick,dashed,red](1.5,0)--(1.5,0.2)--(1.75,0.6)--(3,0.6);
%
\end{scope}
%
\end{tikzpicture}