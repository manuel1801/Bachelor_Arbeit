...
model = 'ssd_mobilenet_v2_coco_out'
input_stream = 0  # 0 für webcam, oder pfad zu video
threshold = 0.5
...
def main():
    ...
    labels_map = [l.strip() for l in open(os.path.join(
        ...
        if exec_net.requests[cur_request_id].wait(-1) == 0:
            ...
            for obj in res[0][0]:
                ...
                if obj[2] > threshold:
                    ...
                    det_label = labels_map[class_id - 1] if labels_map else str(
                        class_id)
